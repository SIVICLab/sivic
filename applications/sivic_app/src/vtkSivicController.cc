...
void vtkSivicController::DisplayReleaseNotes()
{
...
{
    vtkKWMessageDialog *loadFailed = vtkKWMessageDialog::New();
    loadFailed->SetApplication(app);
    loadFailed->Create();
    loadFailed->SetOptions( vtkKWMessageDialog::ErrorIcon );
    loadFailed->SetText(message.c_str());
    loadFailed->Invoke();
    loadFailed->Delete();
}
